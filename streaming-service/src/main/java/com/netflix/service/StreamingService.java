...
public class StreamingService {
    ...
    public StreamingResponse getStreamingUrl(String movieId, String playlistKey) {
        ...
        // (5 minutes less than that actual expiry to avoid edge cases)
     ...
     * URL expired after configuration time.
     */
    ...
    /**
     * This is key method that make everything secure
     */
    ...
    public void invalidateCache(String movieId) {
        ...
        log.info("Steaming URL cache invalidated for movie: {}", movieId);
    }
}
